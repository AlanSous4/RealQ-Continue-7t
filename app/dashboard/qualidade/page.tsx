    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Gerencie as inspeções de qualidade pendentes e incompletas</p>
        </div>
      </div>
        ...
        <TabsContent value="pending" className="space-y-4">
          <WhiteCard>
            <WhiteCardHeader>
              ...
              <WhiteCardDescription>Inspeções que aguardam análise avançada de qualidade</WhiteCardDescription>
            </WhiteCardHeader>
            <WhiteCardContent>
        ...
        <TabsContent value="incomplete" className="space-y-4">
          <WhiteCard>
            <WhiteCardHeader>
              ...
              <WhiteCardDescription>Inspeções com informações faltantes ou testes incompletos</WhiteCardDescription>
            </WhiteCardHeader>
            <WhiteCardContent>
              <QualityInspectionList type="incomplete" searchTerm={searchTerm} />
            </WhiteCardContent>
          </WhiteCard>
        </TabsContent>
        <TabsContent value="expired" className="space-y-4">
          <WhiteCard>
            <WhiteCardHeader>
              ...
              <WhiteCardDescription>Produtos com data de validade expirada ainda em estoque</WhiteCardDescription>
            </WhiteCardHeader>
            <WhiteCardContent>
